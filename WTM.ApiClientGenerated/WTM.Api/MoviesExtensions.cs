...
namespace WTM.ApiClientGenerated
{
    public static partial class MoviesExtensions
    {
        ...
        /// Reference to the WTM.ApiClientGenerated.IMovies.
        /// </param>
        /// <param name='name'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<WTM.ApiClientGenerated.Models.MovieSearchTagResponse> result = await operations.GetByTagWithOperationResponseAsync(request, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
    }
}
