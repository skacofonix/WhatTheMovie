...
namespace WTM.ApiClientGenerated
{
    public partial interface IShots
    {
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<ShotResponse>> GetByIdWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<ShotSolutionResponse>> GetSolutionWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<ShotGuessTitleResponse>> GuessTitleWithOperationResponseAsync(int id, GuessSolutionRequest request, CancellationToken cancellationToken = default(System.Threading.CancellationToken));
