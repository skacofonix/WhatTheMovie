...
{
    public partial class ShotOverviewResponse
    {
        private ShotOverview _data;
        
        /// <summary>
        /// Optional.
        /// </summary>
        public ShotOverview Data
        {
        ...
        /// <summary>
        /// Initializes a new instance of the ShotOverviewResponse class.
        /// </summary>
        public ShotOverviewResponse()
        {
        }
        ...
        public virtual void DeserializeJson(JToken inputObject)
        {
            if (inputObject != null && inputObject.Type != JTokenType.Null)
            {
                ...
                {
                    ShotOverview shotOverview = new ShotOverview();
                    shotOverview.DeserializeJson(dataValue);
                    this.Data = shotOverview;
                }
